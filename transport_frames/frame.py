...
def _assign_city_names_to_nodes(points, frame, max_distance=3000):
    ...
    projected = gpd.sjoin_nearest(
        points, n, how="left", distance_col="distance", max_distance=max_distance
    )
...
def mark_exits(frame, area_polygon: gpd.GeoDataFrame, regions_polygons: gpd.GeoDataFrame, country_polygon: gpd.GeoDataFrame) -> gpd.GeoDataFrame:
    """
...
def weigh_roads(
        ...
        restricted_terr_gdf: gpd.GeoDataFrame = None
    ) -> gpd.GeoDataFrame:
        """
